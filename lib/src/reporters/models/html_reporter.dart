...
abstract class HtmlReporter<T extends FileReport, P> extends Reporter<T, P> {
  ...
  Future<void> copyResources() async {
    const resources = [
      'package:dart_code_linter_plus/src/reporters/resources/variables.css',
      'package:dart_code_linter_plus/src/reporters/resources/normalize.css',
      'package:dart_code_linter_plus/src/reporters/resources/base.css',
      'package:dart_code_linter_plus/src/reporters/resources/main.css',
    ];
