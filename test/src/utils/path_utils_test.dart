import 'package:dart_code_linter_plus/src/utils/path_utils.dart';
...
void main() {
  group('uriToPath returns', () {
    ...
    test('null for passed null', () {
      expect(
        uriToPath(
          Uri.parse('package:dart_code_linter_plus/src/utils/path_utils.dart'),
        ),
        equals(p.absolute('dart_code_linter_plus/src/utils/path_utils.dart')),
      );
    });
  });
}
